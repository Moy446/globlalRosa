...
<body>
    ...
    <div class="contenedor">
        ...
        <form method="POST" enctype="multipart/form-data" id="modificarProductoForm">
            <div class="ocultar" id="divInfoProducto">
                <div class="mb-3">
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="row g-3 align-items-center separacion">
                        ...
                        <div class="col-auto">
                            <select class="form-select" name="proveedor" id="provedorModificar">
                                <?php
                                    require './php/conexionPrincipal.php';
    ...
    <div class="contenedor separacion">
        <h3>Modificar provedor</h3>                       
        <select class="form-select" aria-label="Provedor" id="selectProveedor">
            <option>Seleccionar alguna empresa Provedora....</option>
            <?php
                require './php/conexionPrincipal.php';
                $Resultado = mysqli_query($conexion, "SELECT * FROM `provedores`");
	            while($row = mysqli_fetch_array($Resultado)){
    	        	echo'<option value="'.$row['empresa'].'" data-id = "'.$row['id_provedor'].'">'.$row['empresa'].'</option>';
	            }
            ?>
        </select>
        <form method="post" enctype="multipart/form-data" id="modificarProveedorForm">
            <div class="ocultar" id="divInfoProveedor">
                <div class="mb-3">
